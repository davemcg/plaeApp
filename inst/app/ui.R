...
shinyUI(
  navbarPage('plae',id = 'nav',
             ...
             tabPanel('Data', # Data ---------
                      ...
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2020_10_19/pseudoBulk_diff_results.tsv.gz", "PseudoBulk Results (~4.5GB)")))),
