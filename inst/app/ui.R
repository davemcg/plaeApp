  ...
  navbarPage('plae',id = 'nav',
             ...
             navbarMenu('Viz', # UMAP ----------
                                 ...
                                 fluidPage(tags$html(lang="en"),
                                           ...
                                           fluidRow(
                                             ...
                                             column(6,
                                                    ...
                                                    fluidRow(column(width = 12,  div(DT::dataTableOutput('gene_scatter_click_info'), style='font-size:75%'))),
                                                    br(),
                                                    fluidRow(column(5,
                                             ...
                                             column(6,
                                                    plotOutput('meta_plot',
                                                      ...
                                                      shinycssloaders::withSpinner(type = 3,
                                                                                   ...
                                                                                   color.background = 'white'),
                                                    fluidRow(column(width = 5, strong('Five nearest cells (click image):'))),
                                                    fluidRow(column(width = 12,  div(DT::dataTableOutput('meta_click_info'), style='font-size:75%'))),
                                                    br(),
                                                    fluidRow(column(5,
                        ...
                        tabPanel('Dotplot', # Dotplot ---------
                                 column(8,
                                        fluidRow(column(9, tags$h1('Dotplot'))),
                                        fluidRow(
                                        ...
                                        fluidRow(
                                          column(3, selectizeInput('dotplot_groups', strong('Group by (two max): '),
                                                                   choices=NULL, multiple=TRUE)),
                                          column(3, selectizeInput('dotplot_filter_cat', strong('Filter category: '),
                                                                   choices=NULL, multiple=FALSE)),
                                          column(3, selectizeInput('dotplot_filter_on', strong('Select: '),
                                                                   choices=NULL, multiple=TRUE)),
                                        ),
             ...
             navbarMenu('Diff Testing',
                        tabPanel('Markers',
                                 fluidPage(column(8,
                                                  ...
                                                  fluidRow('Tests run with across CellType, CellType (Predict), and Cluster and split by organism. The differential testing has been updated (yet again). This time
             ...
             tabPanel('Data', # Data ---------
                      ...
                      br(),
                      fluidRow(column(width = 8, offset = 1, h2("PseudoBulk Diff Testing Results"))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2022_03_22/diff_resultsCellType.tsv.gz", "CellType testing (3.2 GB)")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2022_03_22/diff_resultsCellType(Predict).tsv.gz", "CellType (Predict) testing (3.5 GB)")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2022_03_22/diff_resultsCluster.tsv.gz", "Cluster testing (3.9 GB)")))),
                      fluidRow(column(width = 8, offset = 1, h2("PseudoBulk Data Matrices (and Metadata)"))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2022_03_22/4000-counts-universe-study_accession-scANVIprojection-15-5-20-50-0.1-CellType-Homo_sapiens.meta.tsv.gz", "Homo sapiens CellType Metadata")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2022_03_22/4000-counts-universe-study_accession-scANVIprojection-15-5-20-50-0.1-CellType-Homo_sapiens.pseudoCounts.tsv.gz", "Homo sapiens CellType PseudoBulk Counts")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2022_03_22/4000-counts-universe-study_accession-scANVIprojection-15-5-20-50-0.1-CellType-Macaca_fascicularis.meta.tsv.gz", "Macaca fascicularis CellType Metadata")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2022_03_22/4000-counts-universe-study_accession-scANVIprojection-15-5-20-50-0.1-CellType-Macaca_fascicularis.pseudoCounts.tsv.gz", "Macaca fascicularis CellType PseudoBulk Counts")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2022_03_22/4000-counts-universe-study_accession-scANVIprojection-15-5-20-50-0.1-CellType-Mus_musculus.meta.tsv.gz", "Mus musculus CellType Metadata")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2022_03_22/4000-counts-universe-study_accession-scANVIprojection-15-5-20-50-0.1-CellType-Mus_musculus.pseudoCounts.tsv.gz", "Mus musculus CellType PseudoBulk Counts")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2022_03_22/4000-counts-universe-study_accession-scANVIprojection-15-5-20-50-0.1-CellType_predict-Homo_sapiens.meta.tsv.gz", "Homo sapiens CellType_predict Metadata")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2022_03_22/4000-counts-universe-study_accession-scANVIprojection-15-5-20-50-0.1-CellType_predict-Homo_sapiens.pseudoCounts.tsv.gz", "Homo sapiens CellType_predict PseudoBulk Counts")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2022_03_22/4000-counts-universe-study_accession-scANVIprojection-15-5-20-50-0.1-CellType_predict-Macaca_fascicularis.meta.tsv.gz", "Macaca fascicularis CellType_predict Metadata")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2022_03_22/4000-counts-universe-study_accession-scANVIprojection-15-5-20-50-0.1-CellType_predict-Macaca_fascicularis.pseudoCounts.tsv.gz", "Macaca fascicularis CellType_predict PseudoBulk Counts")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2022_03_22/4000-counts-universe-study_accession-scANVIprojection-15-5-20-50-0.1-CellType_predict-Mus_musculus.meta.tsv.gz", "Mus musculus CellType_predict Metadata")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2022_03_22/4000-counts-universe-study_accession-scANVIprojection-15-5-20-50-0.1-CellType_predict-Mus_musculus.pseudoCounts.tsv.gz", "Mus musculus CellType_predict PseudoBulk Counts")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2022_03_22/4000-counts-universe-study_accession-scANVIprojection-15-5-20-50-0.1-cluster-Homo_sapiens.meta.tsv.gz", "Homo sapiens cluster Metadata")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2022_03_22/4000-counts-universe-study_accession-scANVIprojection-15-5-20-50-0.1-cluster-Homo_sapiens.pseudoCounts.tsv.gz", "Homo sapiens cluster PseudoBulk Counts")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2022_03_22/4000-counts-universe-study_accession-scANVIprojection-15-5-20-50-0.1-cluster-Macaca_fascicularis.meta.tsv.gz", "Macaca fascicularis cluster Metadata")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2022_03_22/4000-counts-universe-study_accession-scANVIprojection-15-5-20-50-0.1-cluster-Macaca_fascicularis.pseudoCounts.tsv.gz", "Macaca fascicularis cluster PseudoBulk Counts")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2022_03_22/4000-counts-universe-study_accession-scANVIprojection-15-5-20-50-0.1-cluster-Mus_musculus.meta.tsv.gz", "Mus musculus cluster Metadata")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2022_03_22/4000-counts-universe-study_accession-scANVIprojection-15-5-20-50-0.1-cluster-Mus_musculus.pseudoCounts.tsv.gz", "Mus musculus cluster PseudoBulk Counts")))),
             ...
             navbarMenu('Info', # Info ------
                        tabPanel('Overview', # Overview ------
                                 fluidPage(
                                   ...
                                   fluidRow(column(width = 8, offset = 1, 'Labelled cell types from published papers were pulled, where possible, from a combination of the Sequence Read Archive (SRA), lab web sites, and personal correspondence, then adjusted to be consistent (e.g. MG to Muller Glia) between all studies. Only cell type - study combinations with >50 cells were included in this table.')),
                                   br(),br(),
                                   ...
                                   fluidRow(column(width = 8, offset = 1, 'The labels above were used to create a machine learning modeled which was used to relabel all* cells in the scEiaD (*above a confidence threshold of 0.5). Only cell type - study combinations with >50 cells were included in this table.'))),
                                 br(),br(),
                                 fluidRow(includeHTML("www/footer.html"))),
                        ...
                        tabPanel('Change Log', # Change Log ------
                                 ...
                                 fluidRow(column(width = 8, offset = 1, '0.93 (2023-02-16): Added the ability to download the plot data for the UMAPs, Exp Plot, Dot Plot, and Heatmaps. New quick analysis document added',  tags$a(href="(http://plae.nei.nih.gov/plae_custom_plotting.html", "here"), "which gives a quick workthrough about how to recreate the plot locally in R. Enhanced the help button info (\"Page Pop Up\"")),
                                 br(),
