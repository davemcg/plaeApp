...
shinyUI(
  navbarPage('plae',id = 'nav',
             ...
             tabPanel('Data', # Data ---------
                      ...
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2021_10_11/scEiaD_all_seurat_v3.Rdata", "All (~25 GB)")))),
                      fluidRow(column(width = 8, offset = 1, h2("AnnData Objects"))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2021_10_11/scEiaD_all_anndata.h5ad", "All (~8 GB)")))),
                      fluidRow(column(width = 8, offset = 1, h2("Diff Testing Results"))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2021_10_11/wilcox_diff_results.tsv.gz", "All Diff Results (~1.1GB)")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2021_10_11/wilcox_diff_resultsCellType.tsv.gz", "CellType (Predict) against CellType testing")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2021_10_11/wilcox_diff_resultsCellType(Predict).tsv.gz", "CellType against CellType (Predict)")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2021_10_11/wilcox_diff_resultsCluster.tsv.gz", "Cluster against Cluster")))),
                      fluidRow(column(width = 8, offset = 1, h2("Metadata"))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2021_10_11/metadata_filter.tsv.gz", "Cell Metadata")))),
                      fluidRow(column(width = 8, offset = 1, h2("Counts"))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2021_10_11/counts.Rdata", "Kallisto counts, R sparse matrix (12 GB)")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2021_10_11/counts_unfiltered.Rdata", "Kallisto counts, no filtering, R sparse matrix (15 GB)")))),
             ...
             navbarMenu('Info', # Info ------
                        tabPanel('Overview', # Overview ------
                                 fluidPage(
                                   ...
                                   fluidRow(column(width = 8, offset = 1, 'The article covering of the data creation and benchmarking of version 0.74 data is now publised at (now **not** on plae, but the overall principles are largely the same)', tags$a(href="https://academic.oup.com/gigascience/article/10/10/giab061/6396190", "GigaScience!"))),
                                   br(),
                        ...
                        tabPanel('Change Log', # Change Log ------
                                 ...
                                 br(),
                                 fluidRow(column(width = 8, offset = 1, '0.80 (2021-10-16): MASSIVE update. Chicken data added. Brain choroid added. Trabecular meshword added. Cornea added. Human body tissues added. We now have over one million cells in this resource. Counts cleaned up with ',
