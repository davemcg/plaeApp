...
shinyUI(
  navbarPage('plae',id = 'nav',
             ...
             tabPanel('Data', # Data ---------
                      ...
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2020_10_19/scEiaD_droplet_seurat_v3.Rdata", "Droplet")))),
                      ...
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2020_10_19/scEiaD_droplet_anndata.h5ad", "Droplet")))),
                      ...
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2020_10_19/counts.Rdata", "Kallisto counts, R sparse matrix")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2020_10_19/cpm.Rdata", "Kallisto counts, cpm scaled, R sparse matrix")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2020_10_19/counts_unfiltered.Rdata", "Kallisto counts, no filtering, R sparse matrix")))),
