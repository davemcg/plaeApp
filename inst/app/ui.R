             ...
             navbarMenu('Viz', # UMAP ----------
                                           ...
                                           fluidRow(
                                             ...
                                             column(6,
                                                    ...
                                                    fluidRow(
                                                      ...
                                                      column(5, downloadButton('BUTTON_download_scatter','
                                                    ...
                                                    fluidRow(
                                                      column(5,
                                                             actionButton('BUTTON_draw_meta',' Draw Meta Plot', icon = icon("arrow-up"),
                                                                          style='background-color: #3366ff; color: #ffffff')),
                                                      column(5, downloadButton('BUTTON_download_meta','
                                                                      Download Meta Plot',
                                                                               style='background-color: #3366ff; color: #ffffff'))),
                                                    br(),
                                                    fluidRow(column(5,
                        ...
                        tabPanel('Expression Plot',
                                 column(12,
                                        ...
                                        fluidRow(column(5, actionButton('BUTTON_draw_exp_plot','Draw Plot', icon = icon("arrow-down"),
                                                                         style='background-color: #3366ff; color: #ffffff')),
                                                 column(5, downloadButton('BUTTON_download_exp','
                                                                      Download Scatter Plot',
                                                                          style='background-color: #3366ff; color: #ffffff'))),
                                        br(),
                                        ...
                                        fluidRow(
                                          column(10,
                                                 ...
                                                 fluidRow(column(5, actionButton('BUTTON_draw_filter','Draw Plot', icon = icon("arrow-down"),
                                                                                  style='background-color: #3366ff; color: #ffffff')),
                                                          column(5, downloadButton('BUTTON_download_facet','
                                                                      Download Scatter Plot',
                                                                                   style='background-color: #3366ff; color: #ffffff'))),
                                                 br(),
                        ...
                        tabPanel('Dotplot', # Dotplot ---------
                                 column(8,
                                        ...
                                        actionButton('BUTTON_draw_dotplot','Draw Dotplot!', icon = icon("arrow-down"),
                                                     style='background-color: #3366ff; color: #ffffff'),
                                        downloadButton('BUTTON_download_dotplot','
                                                                      Download Dot Plot',
                                                     style='background-color: #3366ff; color: #ffffff'),
