...
shinyUI(
  navbarPage('Ocular PLAE',id = 'nav',
             ...
             tabPanel('Data', # Data ---------
                      ...
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2020_08_13/scEiaD_droplet_seurat_v3.h5ad", "Droplet")))),
                      fluidRow(column(width = 8, offset = 1, tags$li(tags$a(href="http://hpc.nih.gov/~mcgaugheyd/scEiaD/2020_08_13/scEiaD_well_seurat_v3.h5ad", "Well")))),
