...
library(Seurat)
library(tidyverse)
#system('wget -O ~/data/scEiaD/scEiaD_all_seurat_v3.Rdata http://hpc.nih.gov/~mcgaugheyd/scEiaD/2021_02_17/scEiaD_all_seurat_v3.Rdata')
...
diff_test %>% arrange(avg_logFC) %>% head(20)
```
