...
![](screenshots/rho_in_situ.png){width=50%}

![](screenshots/rpe65_in_situ.png){width=50%}
...
![](screenshots/atoh7_umap_navigation.png){width=75%}
...
![](screenshots/atoh7_umap.png){width=75%}
...
![](screenshots/atoh7_umap_filtered.png){width=75%}
...
![](screenshots/atoh7_umap_filtered_human_only.png){width=75%}
...
![](screenshots/atoh7_table.png){width=75%}
...
![](screenshots/atoh7_table_search.png){width=75%}
...
![](screenshots/meta_table_studies.png){width=75%}
...
![](screenshots/atoh7_umap_clark_only.png){width=75%}

![](screenshots/atoh7_table_clark_only.png){width=75%}
...
diff_test %>% arrange(-avg_log2FC) %>% head(5)
```
...
diff_test %>% arrange(avg_log2FC) %>% head(20)
```
